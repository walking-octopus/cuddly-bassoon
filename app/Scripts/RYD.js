...
// TODO: This script doesn't work well on mobile, so I might rewrite it.
// I hacked together a solution for dislike refresh in mobile youtube
...
function setInitialState() {
  if (oldVideoId == getVideoId()) { return }

  setState();
  oldVideoId = getVideoId();
}
